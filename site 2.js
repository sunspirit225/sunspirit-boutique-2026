...
(function(){
  ...
  window.renderGallery = function(){
    ...
    // Defilement automatique : une image apres l'autre, en boucle
    var autoTimer = null;
    var userPaused = false;
    var resumeTimeout = null;

    function slideWidth(){
      var first = track.querySelector('.gallery-slide');
      return first ? first.offsetWidth + 18 : 238; // 18 = gap
    }
    ...
    autoTimer = setInterval(autoAdvance, 2600);

    function pauseThenResume(){
      userPaused = true;
      clearTimeout(resumeTimeout);
      resumeTimeout = setTimeout(function(){ userPaused = false; }, 5000);
    }
